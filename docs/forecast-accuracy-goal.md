...
### Índice de janelas já usadas no desenvolvimento

`outputs/inventario-janelas-desenvolvimento-radar-20260922/` reúne seis
entradas com protocolos e hashes: julho/2020, maio/2021, maio–junho/2022,
setembro/2023, abril–01/maio/2024 e blocos originais de 2025/2026.
SHA256 de `known-windows.json`:
`6a0156b38b40593ffde22baa6620d83ca1596428271bef640838df8e85ad48fe`.
As reservas de 2021/2022 já avaliadas são explicitamente desenvolvimento
conhecido. O índice é parcial: a ausência de uma data não certifica que
ela nunca foi consultada. Antes de reservar outra janela, verificar
consultas, boletins, previsões e métricas anteriores e declarar a exposição.
Nenhum ajuste ou nova avaliação de modelos nesta etapa.


## Duas janelas históricas candidatas de 2018 localizadas

O agente de pesquisa concluiu `outputs/pesquisa-janelas-ineditas-20260922/`
com quatro buscas, dois GETs de boletins SGB e duas sondagens ANA,
sem coleta de auxiliares, treino ou inferência. O índice oficial já
preservado justificou as datas antes da inspeção de erros de modelos.

As janelas literais 30/08–05/09/2018 e 30/09–06/10/2018 trouxeram
168 registros horários cada, todos de Muçum 86510000, sem duplicatas
ou lacunas na grade horária recebida. Há 164 e 165 níveis aprovados;
quatro suspeitos na primeira, dois suspeitos e um não avaliado na segunda.
Todos os 336 níveis finais são finitos e positivos, mas somente os 329
aprovados podem ser alvos. O coordenador repetiu as contagens diretamente
nos XMLs. Não se inferiu ausência de dados em todos os outros acervos.

Os máximos discretos aprovados foram 9,12 m em 03/09/2018 07h e
11,66 m em 04/10/2018 03h, sem certificar picos contínuos. Dois pontos
coincidem numericamente com boletins SGB: 8,45 m em 02/09 17h e
11,26 m em 03/10 22h. Esses boletins declaravam sistema em teste e
os níveis de Muçum abaixo do limiar de inundação neles indicado.
Não se certificou inundação urbana, independência dos eventos, fuso,
datum, revisões ou publicação histórica por esses dois confrontos.

A grade horária é incompatível com a âncora atual: para origem O,
a consulta O−15 min encontra a leitura O−1h, com 45 min após a consulta,
além da expiração permitida de 15 min. Resultam zero âncoras admissíveis
nas duas respostas. Nenhum horário foi arredondado, interpolado ou
reclassificado; nenhum contrato mudou para acomodar os dados.
Qualquer experimento que aceite outro atraso/resolução precisa de
protocolo explícito prévio e comparação equivalente, mantendo separados
os períodos já utilizados. A disponibilidade dos demais insumos permanece
por verificar; essas semanas são candidatas documentais, não matrizes
prontas para treinar.

O agente passou 10 verificações e o coordenador conferiu os 27 hashes
e tamanhos. Manifesto
`7a864c6ec28cb2452c5f005400449f1c444978d446e9aeed0439e9ab01b6ce72`.
O acervo ganhou dados aprovados de dois períodos novos, sem ganho de
precisão ainda medido. A meta de 98% permanece ativa e não comprovada.


## Compatibilidade de âncora horária para os dados de 2018

A rodada anterior foi progresso: recuperou duas séries novas e identificou
um impedimento concreto para o contrato de 15 min. Nesta etapa, o protocolo
`docs/radar-2018-hourly-anchor-protocol.json` foi registrado antes da
preparação; SHA256 `47576ac5b6f1e05c6a45ff0aabfc4536f8f22fe424a4aece89f0399ca15ccc51`.
A hipótese exclusivamente experimental usa o nível exato e aprovado de
O−1h como base. Não é uma alteração operacional nem prova de disponibilidade
histórica em tempo real. Mantiveram-se timestamps literais, sem atribuir fuso.

`scripts/hydro_radar_hourly_anchor_audit.py` produziu
`outputs/diagnostico-ancora-horaria-2018-20260922/`: 336 origens,
1.680 rastros de derivadas, 3.876 linhas origem/alvo dentro das duas
janelas, 48 métricas e 2.714 verificações. Derivadas de 1, 2, 4 e 8h
exigem ambas as pontas exatas/aprovadas e usam seu intervalo real.
A derivada de 0,5h fica ausente em todas as linhas; não se interpola,
carrega valor anterior ou atravessa o intervalo entre setembro e outubro.
O contrato atual O−15/expiração15 continua tendo zero âncoras nessas séries.

Somando as duas semanas, exclusivamente para disponibilidade:

| Horizonte nominal | Alvos aprovados | Pares base/alvo | Pares com todas as quatro derivadas horárias | Pares base/alvo com alvo≥7m |
|---|---:|---:|---:|---:|
| 1h | 327 | 320 | 284 | 101 |
| 6h | 317 | 308 | 273 | 99 |
| 12h | 306 | 297 | 261 | 98 |

O denominador programado é 334/324/312 respectivamente; as exclusões
na fronteira final são explícitas. Em 12h existem nove alvos aprovados
sem base aprovada. Esses pares não são previsões, eventos independentes,
acertos ou medição de assertividade. Nenhum conjunto tem os seis campos
locais completos devido à falta da derivada de meia hora. Esses campos
locais também não formam a matriz completa de entrada do Radar.

Todos os cinco hashes de fonte foram reconferidos ao final. Manifesto
`e9a1744845a8d4c09ce149cfd203f04e1b9858cb049071fb22e451e4120cc4eb`.
Nenhum treino, inferência, alteração operacional ou promoção ocorreu.
Um treino posterior precisa fixar contratos equivalentes para os anos,
controles e candidatos; não pode usar cobertura como prova de ganho.


### Montante de 2018 e conferência independente da âncora

`outputs/pesquisa-montante-2018-20260922/` concluiu seis sondagens
ANA, sem repetição ou busca adicional. Linha José Júlio 86472000 tem
668 e 672 níveis finais aprovados a cada 15 min nas duas semanas;
o coordenador confirmou as contagens/QC diretamente nos XMLs. Faltam
somente 05/09/2018 15:45, 16:00, 16:15 e 16:30 na primeira semana:
são quatro posições ausentes e intervalo de 75 min entre as observações
adjacentes, sem preenchimento. Os 1.340 níveis são finitos/positivos,
sem duplicatas. Santa Tereza e Carreiro retornaram quatro HTTP200 com
mensagem de aplicação Sem dados, preservada; isso não prova ausência
em outros acervos e não deve ser convertido em série de zeros.

O boletim contemporâneo de 02/09/2018 17h indicava Linha em manutenção,
mas o acervo consultado agora fornece 931 cm aprovados nesse instante.
A divergência reforça que disponibilidade retrospectiva não certifica
publicação na época. Em 03/10/2018 22h, os 1.282 cm coincidem com o
boletim; nenhum dos confrontos certifica toda a cronologia ou datum.

O suplemento independente da âncora, sem importar o builder, passou
6.625 verificações: 336 origens, 1.680 rastros, 3.876 alvos, 48 grupos,
156 exclusões de fronteira e hashes. Reproduziu os pares h1/6/12
160/153/147 e 160/155/150, a ausência integral de dH0,5, a seleção
exata de alvos aprovados e a ausência de ponte entre semanas.
Os sete QC não aprovados continuam excluídos e os alvos desconhecidos
não foram classificados como cheias. O contrato operacional permanece igual.

O coordenador conferiu os 29 hashes/tamanhos da pesquisa; manifesto
`25dd8d5af8fcdfe3bf4faccbb837e00d6b3c6b00c0a5b7efec011999e55a628a`.
A coleta passou 25 verificações próprias. Chuva, vazões e demais insumos
para uma matriz histórica completa ainda não foram verificados nesta
etapa. Nenhum modelo foi ajustado ou promovido, e nenhum ganho de
assertividade foi inferido da maior cobertura de dados.


## Dados ONS de 2018 para completar os insumos históricos

A rodada anterior foi progresso: recuperou montante e conferiu uma
hipótese explícita de âncora horária. Nesta etapa foram três GETs públicos
ONS, com URLs selecionadas do catálogo preservado antes da coleta, sem
retries. `outputs/auditoria-qi-radar-2018-20260922/` mantém agosto,
setembro e outubro/2018 completos, recibos HTTP, hashes e extração literal
de 6.621 registros de 14 de Julho, Monte Claro e Castro Alves.

Há 744/720/743 registros por usina nos três meses. Falta em outubro
somente o rótulo 20/10 23:59 em relação ao padrão diário recebido de
01h..23h e 23:59; está fora das duas janelas e a causa não foi inferida.
Não há Q/I zero, negativo ou ausente nesses registros, nem resíduo
absoluto Q−(turbinada+vertida+outras) acima do limiar diagnóstico 1 m³/s.
Isso não certifica qualidade hidráulica, principalmente da afluência.

As 336 origens das duas semanas têm todas as 6.048 consultas disponíveis
sob atraso declarado de 60 min e idade máxima de 90 min após a consulta.
Essa hipótese de atraso não é prova da primeira publicação histórica.
Os timestamps literais, incluindo 23:59, foram mantidos, sem normalização,
preenchimento ou substituição dos campos. Nenhuma previsão ou treino.
Manifesto da coleta/auditoria:
`de4d82f7cbea256a27e6f34cb4c0e97902616bda37be44e17e1def25c9c12ce8`.

`outputs/verificacao-qi-radar-2018-20260922/` fez a reconstrução direta
dos 6.621 registros a partir dos CSVs brutos e verificou as 6.048 buscas,
proveniência e cronologia, com 36.884 verificações aprovadas. Nenhum dado
foi convertido em evidência prospectiva nem o modelo operacional alterado.


### Coleta ANA completa e limites estruturais da chuva em 2018

O agente fechou `outputs/radar-insumos-observados-2018-20260922/`:
54 GETs novos mais oito respostas reutilizadas, todos HTTP200;
42 respostas com registros e 20 mensagens Sem dados. As 54 séries
por posto/janela reúnem 9.626 registros ALL-QC sem duplicatas/conflitos.
Foram 319 verificações, e o coordenador conferiu os 246 hashes e tamanhos.
Manifesto `9bc8ed6d3a4380d7e6935a33b59cfa3350c59222713c52ffd54ed7641ad96b7a`.
Cada janela inclui três dias de aquecimento, preservados separadamente.

Oito postos não têm dados nas duas consultas. Muçum tem 240 registros
horários por janela, com 236/237 níveis aprovados. Linha tem 956/960
registros de 15 min. As chuvas finitas/aprovadas somam 4.860/4.757;
duas células vazias e sete com outro QC não foram preenchidas ou
convertidas em aprovação. Postos com cadência de 3–4h, lacunas longas,
série curta e uma leitura literal às 23:01 permanecem explícitos.
A mera contagem de linhas não mede horas integráveis ou chuva regional.

`outputs/limites-cobertura-chuva-2018-20260922/` registra um teste
estrutural antes de qualquer ajuste: cada estação recebe seu peso inteiro
somente se houver ao menos um incremento aprovado, finito, entre 0 e
150 mm, encerrando intervalo positivo de no máximo 5.400 s na janela.
Isso dá um limite superior deliberadamente generoso, sem garantir que
as estações tenham cobertura simultânea em cada origem/acumulado.
Os pesos originais não foram renormalizados. Nas duas janelas, os limites
são Baixo Antas 0,786127; Carreiro 0,879875; Prata–Turvo 0,498934;
Alto Antas 0,592098; Tainhas 0,158470.

Logo, Prata–Turvo e Tainhas não alcançam o limiar de 0,5 sob os pesos
e acervo atuais, mesmo nesse limite superior. Suas chuvas regionais
não podem ser declaradas conhecidas mediante arredondamento ou ajuste
do denominador. Nos outros grupos, passar esse limite superior não
comprova disponibilidade: a integração temporal ainda precisa ser feita.
Não houve matriz completa, inferência, treino, promoção ou mudança no
modelo operacional nesta rodada; a meta de 98% permanece não comprovada.


## Matrizes observadas de 2018 com âncora horária explícita

A rodada anterior foi progresso: completou coleta ANA/ONS e demonstrou
limites de cobertura regional. O protocolo
`docs/radar-2018-observed-features-protocol.json` foi registrado antes
à preparação; SHA256 `952c2f7c51c59c26b6d2497c8ea688c09c980bed95eb33d15a6004cac8b72ca2`.
Em `outputs/radar-matrizes-observadas-2018-20260922/`, cada janela tem
168 origens e 120 variáveis na ordem observada do Radar. São 164/165
bases e 164/165 verdades aprovadas, com 7.257/6.913 células ausentes.
Não há previsão meteorológica, treino ou inferência nestes arquivos.

A única adaptação de tempo no nível é a hipótese Muçum exato O−1h,
sem tolerância; dH0,5 permanece ausente. Linha segue30min/max15,
Santa15min/max15 e Carreiro30min/max15. Toda entrada ANA e verdade
exige QCexplicitamente aprovado, finita/não negativa; chuva<=150mm.
Esse QCestrito difere do helper antigo que permite QCausente e precisará
ser aplicado igualmente aos controles em qualquer treino posterior.
FusoUTC−3 é hipótese de cálculo, sem certificação documental. Os dados
brutos literais e os rastros permitem conferi-la sem alterar fontes.

As duas janelas não foram concatenadas antes de construir defasagens.
Com os três dias de aquecimento reais, há pares base/alvo h1/6/12
161/154/148 na primeira e161/156/151 na segunda. São dois pares totais
a mais por horizonte do que a sondagem anterior de sete dias, pois agora
existe a base exata anterior à primeira origem em cada semana. Não houve
imputação. Alvos aprovados porh continuam163/158/152 e164/159/154.

A chuva usa o integrador já existente, pesos fixos e atrasos congelados,
sem reduzir o limiar0,5. Carreiro tem168origens utilizáveis para todos
os seis acumulados nas duas semanas. BaixoAntas tem zero para1h,
129para3/6/12/24/48h na primeira e168nesses acumulados na segunda.
Prata–Turvo e Tainhas têm zero para todos os acumulados. AltoAntas tem
apenas4/2origens utilizáveis de1h e zero nos demais acumulados.
Essa disponibilidade depende da janela temporal, cadência e pesos;
nenhuma chuva ausente foi tratada como seca ou cobertura recuperada.

ONS usa valores literais, atraso60/max90 e os diagnósticos preservados,
sem corrigir23:59 ou substituir componentes. Os arquivos incluem matrizes
horárias, grades de15min, catálogo de120campos, rastros de nível, cobertura
de chuva/alvos e hashes de todas as fontes/código. O coordenador conferiu
os hashes dos artefatos. Manifesto
`0e3ea4d6d4b9f087f5f6ecc7a1b3120d2f9784aa9c90ea8a65c7999600397c5c`.
A conferência independente da reconstrução está em andamento antes de
qualquer treino. Nenhuma alteração operacional ou evidência de98%.


### Auditoria independente final das matrizes de 2018

`outputs/verificacao-radar-matrizes-2018-20260922/` concluiu a conferência:
17.553 verificações, 40.320 células reconstruídas e padrões de NaN
7.257/6.913 idênticos. Níveis/QI coincidem exatamente; a integração
independente de chuva por sobreposição geométrica difere no máximo
2,84217e−14, dentro da tolerância declarada2e−10. Essa diferença pequena
não prova invariância de árvores futuras e não foi ocultada/arredondada.

A auditoria conferiu 1.344 rastros de nível, 6.048 consultas QI,
24 grupos de alvos, 60 grupos de cobertura de chuva, 240 colunas/janelas
e catálogos/hashes. No posto86200900 somente5/8intervalos passam o limite
de5.400s; não se dividem intervalos de3/4h em horas sintéticas.
A leitura23:01 mantém intervalos reais60/3.540s, sem arredondamento.
Os máximos de cobertura Prata–Turvo0,4989339 e Tainhas0,1584699
continuam abaixo0,5. Nenhuma ponte entre semanas ou seleção indevida deQC.

O coordenador conferiu os17artefatos e tamanhos. Manifesto
`74d77fb7a3d10f9b053c8cfa0f0bfafb0c99e51093bad89015cac10c10e9d911`.
Matrizes preparadas e verificadas, sem ajuste ou ganho de precisão declarado.

## Ciclo regular das 03h — 22/09/2026

O processo de `outputs/mucum-hourly-20260922T030119-0300/` terminou0,
e a emissão única foi registrada às03:05:32,610787BRT. Recibo
`e533cd9767fad2938d67ce7449b2e20aca185bac0b610c5d0b9511728213168d`.
A medição usada é18,67m às02:45, com20,5435min de idade na emissão.
Foram133coletas, dois erros auxiliaresSIGMA e nenhum erro nas fontes
obrigatóriasANA/CERAN/Open-Meteo. O log da execução foi preservado na pasta.

A verificação posterior conferiu22artefatos e200recibos de entrada,
reproduziu exatamente14inferências salvas, confirmou unicidade da emissão,
ciclo concluído e bandas de antecedência real0..13 incluindo1..12.
Às04h o ponto experimental é18,83538m; o maior ponto horário é18,91888m
às06h; às17h é16,08989m. O máximo da grade não certifica pico contínuo.
O ponto de04h tem0,90761h reais de antecedência e não é contado como1h.

`outputs/auditoria-suporte-radar-live-03h-20260922/` verificou14índices
de treino e2.520limites univariados. A base18,67m supera o máximo da
base de treino15,30m e o máximo do alvo15,31m. Há16entradas acima e3
abaixo dos intervalos de treino porhorizonte, sem entradas ausentes.
As faixas não são intervalos de confiança nem limites de truncamento.
O corte permanece21/09/2026 00hBRT e o último alvo de treino20/09 23h;
10.875linhas emh1 e10.843emh14. Nenhum avanço do corte ou promoção.
Manifesto de suporte `0d0224996eb832863b1c871c5f31f3be4a4a61b64ea2e55936f91cd6df54fb0d`, com4hashes conferidos.

Relatório `outputs/monitoramento-prospectivo/reports/20260922T060532715678Z/`:
2.807registros,193pares programados,73pareados,13ainda sem observação
exata após o horário-alvo e107futuros; zero pares elegíveis à meta.
Há9/9janelas encerradas com entrega completa, o que não é assertividade
nem prova de acionamento automático do agendador. Fuso/datum continuam
pendentes e a meta de98% permanece ativa e não comprovada.


## Alinhamento dos dados recentes antes da adição de 2018

A rodada anterior foi progresso: matrizes2018 verificadas e ciclo03h
concluído. Antes de ajustar modelos com2018, a auditoria
`outputs/auditoria-contrato-qc-recente-2018-20260922/` reconstruiu86XMLs
dos27postos, na precedência2025→principal→latest→fresh15h.
Os54arrays de nível/chuva do cache foram reproduzidos exatamente;
não houve nenhum valor finito admitido somente porQCausente nem revisão
invalidante pulada nos dois campos e fontes examinados. A possibilidade
estrutural no algoritmo antigo não foi apresentada como erro observado.

A reconstrução strict/latest coincidiu com o legado neste acervo. O
suplemento refez1.551.360células das120colunas observadas, bases e verdades
exatamente, e vinculou56hashes de insumos da auditoria anterior de chuva.
Foram237verificações próprias. O coordenador conferiu70hashes/tamanhos;
manifesto `b1b4bdb5c35bb8c0ba1ab0b83c343ced00c29db596f47b333b8be874ac3979cd`.
Os27NPZs strict-latest preservam timestamps, nível/chuva, máscaras,
QCtextual, source_id e índice XML; nenhum cache original foi alterado.
A ordem documental não foi certificada como cronologia de revisão.

O protocolo `docs/radar-recent-hourly-anchor-features-protocol.json`
registrou a preparação comum: somente níveis horários exatos de Muçum
como base O−1h, dH0,5ausente, QCestrito, demais níveis/chuvas nas mesmas
regras de2018 e Q/I congelados com atraso60/max90. O builder não chama
load_ana/merged/prepare_current nem modifica caches.
`outputs/radar-matriz-recente-ancora-horaria-20260922/` tem12.912origens
anteriores21/09/2026 00h,120colunas,12.835bases e12.836verdades finitas,
28.756NaNs. Manifesto
`8046961ba0cd048f68f46984e28aa10d01b7cc1e931aa09ae9734e439175e95b`.
O número de bases da auditoria sobre12.928origens incluía16horários
posteriores ao corte; não foi contado como divergência neste recorte.

O protocolo de treino separado `docs/radar-2018-hourly-augmentation-protocol.json`
foi escrito antes de qualquer fit; SHA256
`5465f23983731791e0be5772f852a3901b936883d0a12f22829a197d9eef3bd3`.
Planeja48modelos novos, comparando somente-recente contra o mesmo controle
mais todos os exemplos2018admissíveis, nos12horizontes e doisfolds.
Parâmetros, pesos e avaliação idênticos; nenhum ajuste por erro da janela,
nenhum2018usado como teste depois de treinar nele. Os períodos2025/2026
continuam desenvolvimento já conhecido. O treino aguarda a conferência
independente da matrizrecente; nenhuma inferência ou promoção até aqui.


### Conferência recente e tentativa de treino preservada

`outputs/verificacao-radar-matriz-recente-ancora-horaria-20260922/`
passou13.535verificações. As colunas6..119 coincidem exatamente com a
base120anterior; somente a famíliaMuçum0..5 muda pela âncora horária.
O restante dos campos quarter-hour presentes coincide, assim como truth.
Foram conferidas24máscarasrecentes e24de2018, com102.084alvos programados
nos folds. O coordenador conferiu10artefatos; manifesto
`8ab0d4eda3ddcfa59bc4dff1e88d2831a5fa93249a34c7161b54d8a68dc6f6ec`.

A primeira tentativa `outputs/experimento-radar-historico-2018-20260922/`
falhou no primeirofit, validation/controle/h1, antes de qualquer modelo
concluído ou previsão: ValueError de sliding_window_view durante binning.
A coluna1=dH0,5deMuçum, deliberadamente todaNaN, deixa zero valores
distintos; o sklearn1.9.1 local trata um distinto, mas não zero nessa
ramificação. NumPy2.5.3 recusa uma janela2 num vetor vazio.
A pasta e código originais, máscaras/vetores/planos anteriores ao ajuste
foram preservados, com failure.json; manifesto
`2df8649f325477e6f89e5832671fc6d3c4e1fef61961646c45e1885d088b360b`.
Nenhum ambiente ou biblioteca foi alterado.

Antes da nova tentativa, o protocolo
`docs/radar-2018-hourly-augmentation-119-protocol.json` declarou somente
remover a coluna estruturalmente ausente1 em ambos os modelos, mantendo
as matrizes fonte120 intactas. SHA256
`69fe4433ade7cea1e561b9b8558a224745f6b78c23f3b613667400b8d2dc470d`.
O builder usa projeção fixa119salva antes dofit; o recorte upstream18
é calculado nas colunas originais6..23 antes da projeção. Não houve
imputação, seleção porerro ou mudança de máscaras/respostas/pesos.

A auditoria independente `outputs/auditoria-radar-2018-projecao-119-20260922/`
reproduziu a falha apenas no binning de4/8linhas, sem treinoHGB completo.
Seus363checks confirmaram unicamente a coluna1todaNaN nos48fitsets;
após projetar, nenhuma outra coluna inteiramente ausente. Outros198checks
confirmaram48máscaras,144vetores e48planos idênticos, e equivalência do
recorte original6:24 com o projetado5:23. O coordenador conferiu10hashes;
manifesto `afe36b31cb862bd0eac9605bd52bf0ae9d559f5fcba32c378d71d99ffe57be59`.
A auditoria desta etapa não certificou modelos ainda em treino.

### Observação das03h recebida às03h22

A capturaANA de06:22:09,854394UTC trouxe18,68m às03h, Dado aprovado.
Recibo `556dd8a62c7b9111e10248353bc39233bc785f3d661304da42fc069e0cad11f6`;
corpo e cadeia de2.808registros conferidos. Relatório
`outputs/monitoramento-prospectivo/reports/20260922T062209859684Z/`:
86pareados e107futuros, sem alvos vencidos aguardando medição exata;
zero elegíveis à meta, pois fuso/datum continuam pendentes.

Para o alvo03h, o registro00:08BRT previa19,1831278914m, erro0,5031278914m:
permanece ERRO, sem arredondar antes da tolerância0,50m. Os registros
23:02,01:02e02:02BRT erraram0,0492208130;0,4412749075;0,1982676030m.
O último tinha0,964509h reais e não entra na faixa1h. Esses pares
compartilham uma observação, não representam eventos independentes.
Nenhuma previsão foi reescrita para incorporar o resultado observado.


## Resultado do treino com as duas semanas de 2018

A versão119 terminou sem erro: manifesto pré-fit às06:21:37,951098UTC,
conclusão06:24:22,937970UTC. Foram48modelos novos,102.084linhas de avaliação
e288métricas. O coordenador conferiu56artefatos,28fontes e4preparados;
manifesto `bd5ba74c289a5f11af247c160a3e2dd675214b68ebe8a6bc43a293d7c8274695`.
Diretório: `outputs/experimento-radar-historico-2018-119-20260922/`.

Amostras2018adicionadas h1/6/12:322/310/299, sem duplicação ou amostragem
porresultado. No test, as amostrasrecentes são10.845/10.833/10.821;
na validation,4.360/4.355/4.349. O último alvo recente de treino é
30/09/2025 23h para validation e30/06/2026 23h para test. Parâmetros,
vetores de resposta/peso e divisões foram preservados na projeção119.

No recorte observado≥7m de test,237alvos,236pares e uma falha emcada h:

| h | Acertos controle→+2018 | MAE controle→+2018 | Maior erro controle→+2018 |
|---|---:|---:|---:|
|1|228→228|0,130020→0,131165m|2,288854→2,241640m|
|6|151→156|0,657329→0,619989m|6,285061→5,873246m|
|12|79→75|1,419848→1,366877m|8,059888→7,174799m|

A média e o pior erro de12h diminuem, mas os acertos na tolerância
0,50m caem. Na validation≥7m,28alvos/pares, h1melhora27→28acertos,
h6piora21→20 e h12piora9→8; MAE12h0,850095→1,001721m.
Os28/28de um horizonte e período pequeno conhecido não comprovam98%
prospectivos nem independência de eventos.

Nos12horizontes test≥7m, acertos melhoram em8,pioram em3 e empatam em1;
MAE melhora em9 e piora em3; o erro máximo piora em6. Em validation≥7m,
acertos melhoram4,pioram5,empatam3; MAE melhora4,piora8. Para todos os
níveis, acertos test melhoram8/pioram4; validation melhora10/piora2.
Não foi escolhida uma combinação somente dos horizontes favoráveis.

`outputs/analise-radar-historico-2018-119-20260922/` preserva144contrastes
entre os dois modelos, com denominadores e falhas iguais emcadagrupo.
Os recortes de montante usam colsoriginais6..23. As duas famílias são
novos controles sob âncora1h, não reprodução da operação180entradas.
O efeito comparado é adicionar2018 sob essa receita, sem generalizar
para uma alteração operacional distinta. Nenhuma promoção. Avaliação
conhecida de desenvolvimento não prova sucesso prospectivo; a auditoria
independente final dos48modelos/métricas está em andamento.


### Auditoria final do experimento2018/119

`outputs/auditoria-radar-historico-2018-119-20260922/` concluiu a revisão
independente:48aplicações dos modelos salvos reproduzidas exatamente,
102.084linhas,288métricas e1.602verificações aprovadas. As48máscaras,
144vetores e48planos foram reconstruídos e coincidem com a tentativa120.
Os144contrastes independentes confirmam os resultados mistos da análise,
incluindo h12test79→75acertos e validation9→8. Falhas e verdade desconhecida
permanecem separadas; nenhuma alteração de tolerância ou promoção.

O coordenador conferiu10hashes/tamanhos; manifesto
`384289c1cdf4fe9ef296b407a3dff97b25273010f11f3fe1d8b9c0fb5a6ff9b2`.
Os arquivosjoblib não comprovam isoladamente os pesos consumidos pelo
otimizador; a evidência combina código, vetores selados antes dofit,
configurações, máscaras e reprodução. Nenhum novo refit foi necessário.
A etapa fez progresso ao testar e rejeitar a promoção de uma hipótese
concreta. A meta permanece ativa, com98% ainda não demonstrados.


## Diagnóstico dos erros após acrescentar2018

A rodada anterior foi progresso:48modelos e288métricas auditados, candidato
não promovido por regressões. Em `outputs/diagnostico-erros-radar-2018-20260922-v2/`,
foram anotadas102.084linhas e calculados695grupos, com3.456reconciliações.
Manifesto `49c02525a6357f9f1d082f77a7bc68c97e02ccff63afed2950daf0229c466cd8`; artefatos conferidos pelo coordenador.
Nenhum novo fit ou inferência. A primeira tentativa foi interrompida com
SIGTERM no processo18073 após confirmar seu comando e diagnosticar
repetidas descompressões deNPZ dentro do loop; a sessão55212terminou143.
Sua pasta/código foram preservados. A versãofinal usa dict(np.load(...))
para carregar arrays uma vez, sem mudar fórmulas ou fontes, e terminou0.

Em test/12h/observado≥7m:63acertos nos dois,16acertos perdidos,12ganhos,
145erros nos dois e uma falha de previsão. Isso recompõe79→75/237.
Nos145erros persistentes, MAE2,11118→2,02776m; sua soma de erros diminui
12,09536m, diante da redução total12,50106m nos236pares. O benefício
médio ocorreu principalmente sem cruzar a tolerância de0,50m.

A faixa[7,9)m perde50→45/120acertos e MAE0,75603→0,78922m;≥9m ganha
29→30/117(116pares+1falha), MAE2,10656→1,96445m. Esses grupos usam o
alvo futuro somente para diagnóstico. Por tendência conhecida naorigem,
limiares±0,10m/h, descendente ganha26→30/68,estável perde26→21/69 e
ascendente perde27→24/98; dois alvos têm tendência desconhecida.
As datas22–23/julho concentram ganho médio, mas há pioras em outras.
Os17dias reportados não foram chamados de cheias independentes.

A validation/12h também piora9→8/28 e MAE0,85009→1,00172m. Não se
selecionaram os horizontes/faixas favoráveis, não se alterou tolerância
e não se inferiu causalidade física. A decisão de não promover permanece.

### Medição das03h15

Captura06:31:31,572024UTC:18,71m às03h15,Dado aprovado,recibo
`ecc3766eb0d4ebcfc1689c883840b6b029378d551be2850ac64074a37c8bdcab`.
Corpo/cadeia de2.809registros conferidos; relatório
`outputs/monitoramento-prospectivo/reports/20260922T063131574846Z/`
mantém86pareados e107futuros. A medição intermediária não cria novo
par horário. Zero elegíveis à meta, fuso/datum ainda pendentes.


## Nova série de junho/2024 encontrada pelo agente de pesquisa

Em `outputs/pesquisa-mucum-junho2024-20260922/`, pesquisa limitada a quatro
buscas e três GETs encontrou 672 níveis ANA aprovados, a cada 15 minutos,
entre 15 e 21/06/2024. Sem lacunas, duplicatas ou níveis não positivos.
Máximo discreto 17,69 m em 17/06 às 13h15, horário literal; não equivale
a pico contínuo certificado. Os pontos 17/06 às 22h (15,90 m) e 20/06
às 07h (8,79 m) coincidem exatamente com boletins SGB preservados.

O coordenador conferiu os 21 artefatos e nove fontes reutilizadas por
hash/tamanho, além de reconstruir contagem, cadência, QC, máximo e dois
pontos. Manifesto `270030fbc75807c9e3fc516272b01b4e8e593ed3dcd0b637c6bc579c26453cc4`.
Recibo independente: `outputs/verificacao-pesquisa-junho2024-coordenador-20260922.json`.

A disponibilidade de pares de nível sob âncora O−15/max15 é 166/161/155
em h1/6/12, sem certificar as demais entradas do modelo. A primeira
origem não tem margem anterior. Os boletins mantêm aviso de perda de
sensores/PCDs em maio e Linha José Júlio em manutenção. Não certificam
data de reinstalação nem continuidade do zero da régua. Fuso, publicação
histórica, referência e regime operacional pós-avaria permanecem pendentes.
Nenhum offset aplicado, matriz construída, fit ou inferência realizado.
Os níveis já inspecionados não tornam esta janela um teste independente.

Próxima etapa delimitada: resolver metadados e protocolo do regime de
junho antes de decidir elegibilidade para treino; inventariar montante,
chuva e ONS sem misturar automaticamente com regimes anteriores. A meta
permanece ativa; esta descoberta e o diagnóstico do experimento2018 são
progresso, mas não comprovam 98% nem justificam promoção operacional.


## Diagnóstico contra persistência e pesquisa da referência pós-maio

A rodada anterior foi progresso: nova série de junho preservada e conferida.
Nesta rodada, captura às06:43:02,106479UTC, recibo
`bb2ed8692ae82e35ea19384e17c1eadab51fff2dfbb9a09ad97be76f7d785854`,
segue com18,71m às03h15; nenhum horário novo. Cadeia de2.810registros e
corpo conferidos. Relatório `20260922T064302109000Z` permanece com86pares
associados,107não vencidos,zero elegíveis; observação repetida não é nova amostra.

`scripts/hydro_radar_live_persistence_diagnostic.py` gerou
`outputs/diagnostico-persistencia-live-20260922/`:144pontos de12emissões
regulares,48grupos versão/antecedência real1–12,54pares e90futuros.
A referência mantém o último nível usado pelo cálculo, comprovado em
recibo aprovado anterior a cada uma das12emissões. Não afirma ser o
nível mais recente que existia na fonte. A persistência é reconstruída
retrospectivamente e nunca contada como previsão emitida. Arquivos
originais foram mantidos; sem fit, inferência, revisão ou promoção.

Na versão atual fd40fd74e87486e7:10pares sobre apenas4horários-alvo;
Radar8acertos, persistência0; MAE0,229943m versus1,623m. Em bandas
reais1/2/3/4h:4/3/2/1pares e4/2/2/0acertos Radar; nasbandas5–12
ainda zero pares. O agregado não substitui avaliação por horizonte.
Todas as versões foram separadas, sem seleção favorável; mesmas
observações repetidas em previsões diferentes não são eventos independentes.
Conferência independente:400checks de bandas, erros, acertos e48grupos.
Manifesto `05a0f8909c0e9ef4fbb7abcf4a642e625bbe2ffe3b96328b99ddf453ddaa2f67`.
Resultado útil para diagnosticar esta subida, insuficiente para98%.

O agente encerrou `outputs/pesquisa-referencia-mucum-posmaio-20260922/`:
quatro buscas e inspeção do acervo, semGETs novos. Não encontrou ficha
datada de reinstalação/nivelamento específica de86510000. Zero33,985m
da nota de referência e33,96m da nota de marcas seguem sem vínculo de
vigência; nenhuma correção foi aplicada. Isso não prova inexistência
de documento nem torna os níveis inválidos. Mantém-se a incerteza sobre
homogeneidade da série de junho, fuso e disponibilidade histórica.
O coordenador conferiu8artefatos e fontes vinculadas; manifesto
`d022a232229e2fa773b75c13a9d420c3e4ee8a3d373a6fa2192f7bf9218971c2`.
Não repetir estas mesmas buscas sem pista nova. Não houve contato externo.
A meta permanece ativa, somente Radar, sem98%demonstrados.


## Disponibilidade dos preditores de junho/2024

A rodada anterior foi progresso: comparação de persistência reproduzida
e pesquisa documental delimitada. Esta rodada investigou novas entradas
para decidir se junho pode sustentar experimento local, sem alterar
elegibilidade prospectiva ou exigir metadados resolvidos para mera coleta.

`outputs/pesquisa-montante-junho2024-20260922/`:trêsGETs ANA. Linha
86472000 possui672registros/15min, mas níveis final/sensor e ambosQC
vazios; não há âncora válida. Santa Tereza86472600 possui672níveis
aprovados,167/168âncoras; primeiro horário sem margem anterior na
sondagem. Carreiro86500000 retornaHTTP200/ErrorTable Semdados,zero
registros/âncoras. Não se substituiu ausência por zero nem por sensor.
O código86472600 é Santa Tereza, não Santa Lúcia; o erro de nome na
orientação inicial desta rodada foi corrigido pelos boletins SGB,
sem mudar o código consultado ou reescrever fontes seladas.

O agente reconcilia1.344registros XML/JSONL; o coordenador confere22
hashes/tamanhos e1.512checks independentes nos504rastros asof.
Manifesto `6699b4bfb6559d1f5593074cc9828d766f3d8112db2d62807da11e89f4d2376d`.
Nenhuma disponibilidade histórica emtempo real foi inferida da coleta atual.
A exigência operacional atual das24entradas de nível completas não
seria satisfeita em nenhuma origem desta semana pelas fontes consultadas.

`outputs/auditoria-qi-radar-junho2024-20260922/`:umCSV mensal ONS
listado no catálogo,HTTP200,15.510.508bytes;2.160linhas CERAN,720/usina,
30horários literais23:59/usina. Índices de extração são zero-based nas
linhas de dados, sem cabeçalho. Q/I finitos e positivos; isso não éQC
oficial nem certificação de medida independente. Todas as3.024consultas
com lag60/max90 estão disponíveis para168origens de15–21/06.

Julho apresenta37/168linhas centrais com diferença absoluta entre
Qdef e Qtur+Qvert+Qoutras maior que1m³/s, mínimo−169m³/s. São250/720
no mês, mínimo−173m³/s. Incluindo atrasos,43/168origens tocariam esses
registros. Monte/Castro não excedem1m³/s neste acervo. Q=I nas720
linhas deJulho e Qtur=0 nas720deMonte são fatos descritivos, sem inferir
sua origem ou equivalência física de regime. Nenhum campo corrigido.

`outputs/verificacao-qi-radar-junho2024-20260922/` recompõe2.160linhas
e3.024lookups por algoritmo separado,17.296checks. Manifesto aquisição
`fd894bb7ac34f1be6444b5a4bf24aaa654245e77d05a19f1b2bfbbd5a543d692`;
manifesto verificação `11b74c5c9b28ca3f3fa787d29f46a4c4883b63683e86c3d613bddbfac588c8a8`.
Seis referências normativas/dicionário preservadas tiveram hashes
conferidos. O limiar1m³/s é diagnóstico e não reprovação oficial.

A descoberta altera o próximo passo: qualquer experimento com junho
precisa aceitar ausências auxiliares de forma simétrica no controle e
candidato, preservar o regime pós-avaria como limitação e declarar antes
a política de uso/mascaramento de conflitos de vazão. Não copiar a série
como se todas as entradas operacionais existissem. Chuva regional e
matriz integral ainda não foram adquiridas/preparadas nesta etapa.
Nenhum treino/inferência ou promoção. Meta98%ativa e não demonstrada.


## Matriz observada de junho e equivalência do controle recente

A rodada anterior foi progresso: disponibilidadesANA e conflitosONS
mudaram o desenho necessário. Protocolo prévio
`docs/radar-june2024-observed-features-protocol.json`, SHA256
`ff1f890f2beb6b9c0281d770cf5e031b260d4c6b983c662e563cbd58958b984c`,
fixa120variáveis observadas, Muçum15min/max15, QCexplícito, pesos/atrasos
de chuva anteriores e Q/Ias-reported. Não corrige ou mascara conflitos
ONS na preparação; mesma política exigida no controle e candidato.
Regime pós-avaria e metadados pendentes continuam limitações explícitas.

O agente adquiriu27intervalos ANA e reutilizou4respostas jácongeladas:
23respostas comregistros e8Semdados, todasHTTP200. Saída
`outputs/radar-insumos-observados-junho2024-20260922/`,27postos,6.315
linhas ALL-QC,semduplicatas/conflitos,7séries vazias. Muçum960níveis
aprovados; SantaTereza944com16slots ausentes somente noaquecimento;
Linha960semnível,Carreirosemdados. Chuva5.660finita/aprovada,655vazia.
86125000preserva82registros de20/06 07:29a21/06 23:59,cadência30min.
Manifesto130artefatos conferido pelo coordenador:
`7dacc9f7475607775f5d825504ff850561ec6ec21042d876b6f205fb1ca0e19b`.

`scripts/hydro_radar_june2024_features.py` prepara
`outputs/radar-matriz-observada-junho2024-20260922/`:168×120,168bases
e168verdades aprovadas,5.071célulasNaN,zero complete24. H1/6/12têm
167/162/156pares,126alvos≥7m porhorizonte; aquecimento real acrescenta
oprimeiroanchor antes indisponível. Nenhum alvo atravessa fim dajanela.

Prata-Turvo/AltoAntas possuem chuva regional em168origens emtodas
asjanelas1/3/6/12/24/48h. Carreiro possui0emtodas; coberturaabaixo0,5
permaneceNaN. BaixoAntas0/5/104/101/93/78;Tainhas129/128/126/124/119/109.
Não se renormalizaram pesos, não se arredondaram timestamps.
Manifesto matriz `eed44d922e93c42ca204a47237ae757e486f59c6706ad4f44d71ce03fef9cbbe`.

`outputs/verificacao-radar-matriz-junho2024-20260922/` reconstrói20.160
células,672rastrosdenível,3.024lookupsONS e12agendasdealvos:8.797checks.
Níveis/QIexatos; diferençamáxima8,8818e−14emchuva,tolerância2e−10.
Esse limite numérico não prova invariância deárvores futuras. Manifesto
`0da34bedde0f5dddc32e46f973ad5bafd3847189437698535668a2e4aa333e55`.

`scripts/hydro_radar_recent_quarterhour_anchor.py` recompõecontrole
`outputs/radar-matriz-recente-ancora-15min-20260922/`:12.912×120,12.828
bases,12.836verdades,16.035NaNs,10.903complete24. Os1.549.440valores
sãoEXATOSàsprimeiras120colunasda referênciaausênciasnativas,após
cortepredefinido21/09/2026; horários,bases,verdades,máscarastambém.
70hashes daauditoriaQCestrita conferidos. Primeirochecksemfiltraro
originalfalhou12928vs12912;corrigidopela janelaprédeclarada,semalterar
dados. Manifesto `736ac672ba15a3678ef623d65e979d181d4bd0ade2f72bdf3d1d44dca591dbe6`.

Nenhumfit/inferência/promocão nesta preparação. Próximaetapa: protocolo
pareado deadição dejunho,mesmoshorizontes/cortes/pesos/hiperparâmetros
eagenda. Igualdadematricialpermitecomprovar controlepreexistente antes
deajustarcandidato. Todosperíodosinspecionadoscontinuamdesenvolvimento.
Nãohouvedemonstração de98%;metaativa,somenteRadar.


## Ciclo das 04h e experimento com junho de 2024

A rodada anterior foi progresso: matriz de junho e equivalência do controle
foram verificadas. O ciclo regular das 04h terminou sem duplicação, sessão
9156 exit0, em `outputs/mucum-hourly-20260922T040045-0300/`. Emissão Radar
às04:02:50,479553 BRT, recibo
`7155663e72be4f4fa6a60172890c2059150d16a5ee13369af6811a50cdd8b34e`.
Último nível usado18,73m às03h30, idade real32,8413min. Foram133coletas,
duas falhas auxiliaresSIGMA e nenhuma obrigatória ANA/CERAN/Open-Meteo.
22artefatos e200recibos de entrada conferidos;14inferências salvas exatas.
Bandas reais0–13 incluem1–12. A primeira previsão,05h,18,696365m, tem
apenas0,952645h de antecedência real; não conta como1h. É também o maior
ponto previsto da grade, sem certificar pico contínuo. Último ponto18h:
15,282888m. Log movido da pasta temporária para o ciclo.

Suporte `outputs/auditoria-suporte-radar-live-04h-20260922/`:14modelos,
2.520limites por campo,14memberships e replay. Âncora18,73m acima do
máximo15,31m de base/alvo do treino;16campos acima e3abaixo,sem ausentes.
Treino mantém corte21/09/00h; último alvo20/09/23h;10.915exemplos h1
e10.884 h14. Manifesto4artefatos conferido:
`84a00d79e91b6748e12aa6641b2e46644e9b5355c9b91efd4cb53c57e78c9cdd`.
Faixas não são limites de previsão ou intervalo de confiança.

Relatório `20260922T070250593803Z`:3.013registros,207pontos,86pareados,
13sem observação exata,108futuros,zero elegíveis. Dez janelas encerradas
têm entrega completa; isso não prova acionamento pelo agendador nem
precisão. Nova captura07:05:17,939138UTC,recibo
`421118b75e07449266a582b018e974775b48a2e04ae07091c38bd4c3557b4eb5`,
traz18,73m às03h45,Dado aprovado;blob/cadeia3.014registros conferidos.
Relatório `20260922T070517942014Z`; medição intermediária não cria alvo
horário novo. Fuso/datum continuam não certificados.

### Experimento pareado de adição de junho

Protocolo `docs/radar-june2024-augmentation-protocol.json`; código
`scripts/hydro_radar_june2024_augmentation.py`. A revisão independente
fez409checks sem fit/predict:24máscaras e configurações,102.084chaves,
bases,alvos,horários e disponibilidade preservados. Manifesto6artefatos
`b05816509757aea30c530012f93c2f8bbd81207082ee8153c2567f6bb92fc8a2`.
Revisão estática sem bloqueio antes do ajuste; selagem da revisão depois.

O experimento terminou exit0,sessão33019,em
`outputs/experimento-radar-historico-junho2024-20260922/`:24novosmodelos
e24controlesobservados120reproduzidos exatamente,102.084linhas e288
métricas. Não é comparação direta com a operação180. Plano pré-fit
07:03:25,569024UTC sela36máscaras,72vetores e24planos;36fontes e4
artefatos prévios conferidos pelo coordenador. Pesos1+2|delta|≥1+2alvo≥9,
mesmos hiperparâmetros e cortes, sem selecionar horizontes favoráveis.
Junho adiciona167/162/156pares h1/6/12,126alvos≥7 em cada horizonte.
Nenhum alvo cruza lacuna entre junho e2025, fimdejunho ou corte dofold.
Manifesto40artefatos `5846a0684d25c097bab5d714538b7e9cbe17e406b020b7ca7adb9f91b30fde62`.

`outputs/analise-radar-historico-junho2024-20260922/` preserva144
contrastes. No test/alto≥7,237alvos,236pares e1falha por horizonte:
h1acertos230→231,MAE0,077→0,067m;h6 149→157,MAE0,599→0,564m;
h12 83→89,MAE1,362→1,226m. Todos12horizontes melhoram acertos eMAE,
mas3pioram erro máximo. Na validation/alto,28pares:acertos melhoram2,
pioram7,empatam3;MAE melhora3,piora9;10máximos pioram. h6acertos24→25
masMAE0,259→0,319m;h12 7→11,MAE0,908→0,842m. Nosníveis gerais,
testacertos8melhoras/3pioras/1empate eMAE12melhoras;validation3melhoras
/9pioras emacertos e1melhora/11pioras emMAE.

Aumento de dados traz ganho num período e regressões nooutro; candidato
não promovido. Nenhuma alegação de98%, teste independente ou causalidade
física. Auditoria pós-fit independente de pesos/máscaras/replay/métricas
foi iniciada; aguardar seu resultado final antes de dar revisão por encerrada.


### Auditoria pós-fit de junho concluída

`outputs/auditoria-radar-historico-junho2024-20260922/`:4.206checks
aprovados,48replays exatos (24candidatos+24controles),288métricas,
36máscaras,72vetores e24planos/configurações reconstruídos. Os40
artefatos e36inputs doexperimento foram reconferidos pelo auditor.
Ocoordenador conferiu11artefatos finais porhash/tamanho; manifesto
`34b3e28ba4464f002a17b470af6c19af6329a94db50b0829f1a65568b634c7c9`.
Não houve novo fit ou alteração dosmodelos durante a auditoria.

`denominator-partition.csv` separa verdade desconhecida (34porh na
validation,23porh notest), nível conhecidoabaixo7 e alto≥7. Orecorte
alto dotest mantém237observados/236pares/1falha; h12confirma83→89
acertos,MAE1,361813→1,225579m. Não subtrair agenda−altos para chamar
oresultado de dadoausente. Os arquivosjoblib não provam isoladamente
os pesos consumidos; aevidência combina códigoexecutado, vetores
pré-fit, hashes, máscaras, parâmetros e reprodução.

A decisão em `outputs/analise-radar-historico-junho2024-20260922/decision.md`
preserva ausência depromoção porregressões navalidação e avaliação
jáconhecida. Mesmo h1alto dotesttem231/237=97,47% do denominador
observado, amostra insuficiente e nãoprospectiva. Oresultado éprogresso
experimental concreto; a meta98% continua ativa e não demonstrada.


## Diagnóstico das regressões do candidato com junho

A rodada anterior foi progresso:24ajustes e resultados mistos conferidos
por auditoria independente. Nesta rodada,
`scripts/hydro_radar_june2024_error_diagnostic.py` processou102.084
previsões congeladas sem fit/predict. Saída
`outputs/diagnostico-erros-radar-junho2024-20260922/`:691grupos,204
grupos data/horizonte e3.456reconciliações. Conferência separada verificou
as102.084linhas contra asoriginais, transições epartições diárias.
Manifesto `d63aa43e5df73a87b5825bd31625ca0d78fab14032fdf9be0930bdb07db9df16`.

Validation/h9/alto≥7 compreende28alvos em8–9/11/2025. Acertos17→9;
erros positivos>0,50m passam10→18; negativos1→1. Todos28têm18variáveis
de montante completas. Alvos[7,9)m:25pares,15→6acertos,MAE0,645→1,028m.
Alvos≥9m:3pares,2→3acertos,MAE0,313→0,173m. Por tendência conhecida
na origem:subida≥0,1m/h tem12pares,7→1acertos; estável tem16pares,
10→8. Os3alvos≥9m são todos de tendência estável; não confundir com
o grupo crescente. H8 também piora por excesso:7→15casos,20→13acertos.
Datas não equivalem a eventos independentes; nível futuro é diagnóstico,
nunca critério de seleção na emissão.

Composição pré-fit reconstruída para24modelos/96grupos. Emvalidation/h9:
159linhas dejunho versus4.351recentes. Junho representa7,08495% do
peso total,32,9049% do peso de alvos≥7 e36,0603% de alvos≥9. No grupo
|delta|≥1, média assinada1,4315m emjunho versus0,49115m recente; no
grupo de alvos≥7 a média dejunho émenor. Logo oexcesso não pode ser
atribuído a uma simples diferença de média, e nenhuma correção fixa ou
nova ponderação foi aplicada. Respostas/pesos conferem aosvetorespré-fit.
Oresultado motiva examinar concentração de peso deepisódios raros, mas
não prova causa nem autoriza escolher pesos pelos resultados já vistos.

O relatório correto é `README-revisado.md`: revisão editorial preserva
o original e explicita que os3alvos≥9 pertencem ao grupo estável.
`editorial-correction.json` liga os hashes; nenhuma métrica foi alterada.

Captura04:10:35,493322BRT,recibo
`6843cc016cc85c002a893372ca430e15821c9c94ffeb80a4014e6f1dcc05cd19`,
ainda mostra18,73m às03h45. Corpo/cadeia3.015registros verificados;
