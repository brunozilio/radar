"""Audit catalog-listed June2024 ONS resource; preserve literal CERAN fields."""
import bisect
import csv
import hashlib
import json
...
OUT = ROOT / 'outputs/auditoria-qi-radar-junho2024-20260922'
...
def run():
    ...
    dump(OUT / 'collection-plan.json', {
        ...
        'script_sha256': sha(Path(__file__)), 'maximum_gets': 1, 'maximum_bytes_each': 32 * 1024 * 1024,
        'no_retries': True, 'stations': IDS, 'purpose': 'Literal source audit, no fit, inference or operational changes.',
        'windows_including_warmup': [['2024-06-12', '2024-06-21']],
