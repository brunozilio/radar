"""Frozen observed120 RADAR control versus predeclared June2024 augmentation."""
import csv
...
def run():
    ...
    protocol = ROOT/'docs/radar-june2024-augmentation-protocol.json'
    ...
    out = ROOT/'outputs/experimento-radar-historico-junho2024-20260922'
    ...
    for h in range(1,13):
        ...
        for phase in ('validation','test'):
            ...
            prefit_plan.append(dict(phase=phase,horizon_h=h,recent_n=len(idx),added_n=len(added_idx),weight_sum=int(weight.sum()),latest_target=iso((t[idx]+h*3600).max())))
    ...
    for h in range(1,13):
        ...
        print('completed RADAR June2024 augmentation horizon',h,flush=True)
