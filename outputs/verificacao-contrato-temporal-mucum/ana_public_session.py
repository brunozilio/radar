...
for name,url,data in [('ana-public-cookie.json','https://www.snirh.gov.br/hidrotelemetria/Default.aspx/SetCookie',b''),('ana-map-session.html','https://www.snirh.gov.br/hidrotelemetria/Mapa.aspx',None)]:
