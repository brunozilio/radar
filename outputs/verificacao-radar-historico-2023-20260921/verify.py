"""Audit frozen 2023 augmentation without refitting or touching live forecasts."""
import csv
import hashlib
import json
import sys
...
def main():
    ...
    lines=['# RADAR: acréscimo de histórico de2023','',
    ...
    for phase in ('validation','test'):
        for h in (1,6,12):
            for family,label in [('observed_control','Referência120'),('augmented','+2023')]:
